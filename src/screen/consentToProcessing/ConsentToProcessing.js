    ...
    <View>
      <LinearGradient colors={['black', 'black']}>
        ...
        <Text style={[styles.information, {marginTop: 20}]}>
          ...
          http://back.tap-table.ru/ (совместно именуемые Сервис) и направляя
        ...
        <Text style={styles.information}>
          ...
          персональных данных (http://back.tap-table.ru/privacy)
        </Text>
        ...
        <Text style={[styles.header, {marginTop: 5}]}>
          ...
          (http://back.tap-table.ru/useragreement). Такими обязательствами
